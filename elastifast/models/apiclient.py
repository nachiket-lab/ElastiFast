...
class AbstractAPIClient(ABC):
    ...
    def __init__(self, interval: int, base_url: str = None, headers: dict = None, username: str = None, password: str = None, params=None):
    ...
    def fetch_data(self, API_TIMEOUT: int = 10) -> Optional[Dict]:
        ...
        """
        try:
            response = requests.get(self.url, headers=self.headers, timeout=API_TIMEOUT, auth=self.auth, params=self.params)
